...
function getCapabilitiesContext() {
  ...
  return [
    ...
    '  • Prefer agent_write_files when tool calling is available for multiple project files.',
    ...
    '',
    '### 4. agent_write_files / /api/write-files — for complex projects',
    '   When function tools are available, use agent_write_files for multi-file project creation. It writes a structured file list with optional sha256 verification and avoids markdown fence parsing entirely.',
    '   Direct API shape:',
    '   POST /api/write-files { "cwd":"/abs/project", "files":[{"path":"src/app.js","content":"...","sha256":"optional-final-file-hash"}] }',
    '',
