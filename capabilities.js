...
function getCapabilitiesContext() {
  ...
  return [
    ...
    '- NEVER end a response with phrases like "Want me to continue?", "Shall I proceed?", "Let me know if you want me to…", "Do you want me to…", "Should I go ahead?", "Ready for the next step?" — when there is more work to do, just do it.',
    ...
    '  3. For search result pages, JS-rendered pages, screenshots, clicks, forms, logins, blocked fetches, or user-visible browsing, use browser-action / browser-ext-action.',
