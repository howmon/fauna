...
export function renderCircuit(doc) {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="${vbX} ${vbY} ${vbW} ${vbH}" width="${vbW}" height="${vbH}" role="img" data-fauna-circuit="v1" aria-label="${escapeXml(doc.title || 'circuit diagram')}">
${title}
