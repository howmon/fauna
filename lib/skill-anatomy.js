...
const RECOMMENDED_SECTIONS = [
  ...
  { name: 'When to Use',             aliases: ['when to apply', 'triggers'] },
  { name: 'Process',                 aliases: ['core process', 'workflow', 'the workflow', 'steps'] },
  { name: 'Common Rationalizations', aliases: ['rationalizations'] },
  { name: 'Red Flags',               aliases: ['red flag'] },
  { name: 'Verification',            aliases: ['verify', 'evidence', 'exit criteria'] },
];
