...
function getCapabilitiesContext() {
  ...
  return [
    ...
    '- **Orchestrator systemPrompt** (100-200 words, dispatch-only):',
    ...
    '  - For pipelines (step 2 needs step 1 output), emit ONE [DELEGATE:] block at a time. The system loops automatically — after each sub-agent completes, you get its results and can emit the next [DELEGATE:] block.',
    ...
    '  - "systemPrompt": focused prompt for this sub-agent only (100-300 words). It receives shared context automatically — do NOT duplicate shared content here.',
